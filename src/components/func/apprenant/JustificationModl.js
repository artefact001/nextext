...
function JustificationModl({ isOpen, onClose, pointageId }) {
        ...
        <ModalBody>
          {existingJustification ? (
            <>
              ...
              {/* Check if the document is an image or a PDF */}
                <>
                {existingJustification && existingJustification.document ? (
  existingJustification.document.endsWith('.pdf') ? (
    // Make sure console.log() is outside JSX
    <Link
...
export default JustificationModl;
